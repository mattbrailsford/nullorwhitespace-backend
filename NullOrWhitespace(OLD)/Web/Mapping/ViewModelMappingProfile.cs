...
//            Mapper.CreateMap<IPublishedContent, BasicNodeViewModel>()
//                .ForMember(x => x.Type, o => o.MapFrom(x => x.DocumentTypeAlias))
//                .ForMember(x => x.Slug, o => o.MapFrom(x => x.UrlName));
...
//            Mapper.CreateMap<HomePage, BasicNodeViewModel>()
//                .IncludeBase<IPublishedContent, BasicNodeViewModel>()
//                .ForMember(x => x.Slug, o => o.UseValue(""));
